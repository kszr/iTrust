...
import edu.ncsu.csc.itrust.validate.OIRValidator;
...
public class OIRAction {
	 ...
	 * @throws DBException 
	 */
	public void createOIR(OIRBean newOIR) throws FormValidationException, DBException{
		new OIRValidator().validate(newOIR);
