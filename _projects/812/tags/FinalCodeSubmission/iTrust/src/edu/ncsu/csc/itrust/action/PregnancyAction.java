...
import edu.ncsu.csc.itrust.validate.PregnancyValidator;
...
public class PregnancyAction {
	 ...
	 * @throws DBException 
	 */
	public void createPregnancy(PregnancyBean newPregnancy) throws FormValidationException, DBException{
		new PregnancyValidator().validate(newPregnancy);
