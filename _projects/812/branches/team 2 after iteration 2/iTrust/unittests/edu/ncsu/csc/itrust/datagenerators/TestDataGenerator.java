...
//		System.out.println("Operation completed.");
	...
	/**
	 * 
	 * Generate records release data for uc56 acceptance scenarios
	 * Includes recordsrelease table data and UAP-HCP relations
	 */
	...
	/**
	 * Generate dependency data for uc58 acceptance.
	 * Create a dependent user, a representative user, and establish 
	 * representative relationship between the two.
	 */
	...
	/**
	 * Generate dependency data for uc59 acceptance.
	 * Create a dependent user and a representative user
	 */
	...
	/**
	 * Generate dependency data for uc60 acceptance.
	 * Create a Patient and a HCP to bill the patient.
	 * Create a billed office visit the patient can view.
	 */
