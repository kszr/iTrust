...
public class ReviewsDAO {
  ...
  /**
   * Get average rating for the given HCP overall, all categories averaged together.
   * @param pid ID of the HCP
   * @return average overall rating 
   * @throws DBException 
   
  public double getAverageRating(long pid) throws DBException{
	  //TODO find a way to get an overall average rating across all of the categorical columns
	    double avgrating = 0;
	    Connection conn = null;
		PreparedStatement ps = null;
		try {
  ...
  */
  ...
  public double getTotalAverageRating(long pid) throws DBException{
	  //TODO get all overall ratings averaged together 
	    double avgrating = 0;
	    Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
  ...
  //TODO: add individual getters to get the average ratings for each category here
}
