<div class="panel panel-default">
	...
	<div class="panel-body" id="info-menu">
		<ul class="nav nav-sidebar">
			...
			<li><a href="/iTrust/auth/hcp-uap/viewListOfDeceasedPatients.jsp">View List Of Deceased Patients</a>
			<li><a href="/iTrust/auth/hcp-uap/viewCauseOfDeathTrendsReport.jsp">View Cause Of Death Trends Report</a>
		</ul>
	</div>
</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="add-menu">
		<ul class="nav nav-sidebar">
		   <li><a href="/iTrust/auth/hcp-uap/addPatient.jsp">Patient</a>
		   <li><a href="/iTrust/auth/hcp-uap/uploadPatientFile.jsp">Upload Patient File</a>
		   <li><a href="/iTrust/auth/hcp/addUAP.jsp">UAP</a>
		</ul>
	</div>
</div>
