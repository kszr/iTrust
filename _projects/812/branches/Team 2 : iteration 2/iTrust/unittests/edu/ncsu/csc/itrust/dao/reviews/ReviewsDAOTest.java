...
public class ReviewsDAOTest {
	...
	public void setUp() throws Exception {
		...
		evilDAO = EvilDAOFactory.getEvilInstance().getReviewsDAO();
	...
	@Test
	public final void testAddNullReview() {
		try {
	...
	@Test
	public final void testAddNullReview2() {
		try {
			assertFalse(rdao.addReview(null));
		} catch(DBException e) {
			fail();			
	...
	public void testGetAllReviews2() {
		try {
			List<ReviewsBean> reviews = evilDAO.getAllReviews();
			fail();
		}
		catch(DBException e) {
	...
	public void testGetReviews2() {
		try {
			List<ReviewsBean> reviews = evilDAO.getReviews(PID1);
			fail();
		}
		catch(DBException e) {
			assertEquals(EvilDAOFactory.MESSAGE, e.getSQLException().getMessage());
	...
	@Test
	public void testTotalAverageRating() {
		try {
			double rating = evilDAO.getTotalAverageRating(PID1);
			fail();
		}
		catch(DBException e) {
			assertEquals(EvilDAOFactory.MESSAGE, e.getSQLException().getMessage());
